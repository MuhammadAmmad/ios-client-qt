...
-(void)shareMail
{
    ...
    if ([MFMailComposeViewController canSendMail])
    {
        ...
        NSString *msg=[NSString stringWithFormat:@"Sign up for Uber For X with my referral code %@, and get the first ride worth UGXx free!",strForReferralCode];
